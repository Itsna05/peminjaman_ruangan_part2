document.addEventListener('DOMContentLoaded', function () {
    ...
    // =========================
    const monthInput = document.getElementById('timeFilterMonth');
    const yearInput  = document.getElementById('timeFilterYear');
    ...
    function applyFilter() {
        ...
        if (selectedMonth) {
            params.set('bulan', selectedMonth);
        } else {
            params.delete('bulan');
        }
